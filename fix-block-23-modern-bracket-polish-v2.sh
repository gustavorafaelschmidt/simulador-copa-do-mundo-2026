...
echo "==> Aplicando correção v2 — mata-mata moderno sem erro de template literal..."
...
mkdir -p .backup/block-23-modern-bracket-polish-v2 docs
cp components/world-cup/VisualWorldCupSimulator.tsx .backup/block-23-modern-bracket-polish-v2/VisualWorldCupSimulator.tsx.backup
